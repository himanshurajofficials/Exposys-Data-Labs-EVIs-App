...
holder.pbutton.setText("Apply for "+user.getProduct_name()+" Internship");
...
//            Intent intent=new Intent(context, applicantpage.class);
            Intent intent=new Intent(context, internshipform.class);
...
//            Toast.makeText(context, user.getProduct_name()+" added ", Toast.LENGTH_SHORT).show();
